...
ERROR( tenant_group_not_found, 2144, "Tenant group does not exist" )
ERROR( tenant_group_already_exists, 2145, "A tenant group with the given name already exists" )
ERROR( tenant_group_not_empty, 2146, "Tenant group is not empty" )
ERROR( tenant_group_removed, 2147, "The tenant group was removed" )
